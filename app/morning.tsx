...
export default function MorningSupplicationsScreen() {
  ...
  const allSupplications = [
    ...supplications.morning,
    ...customSupplications.filter(s => s.type === 'morning'),
  ];
  ...
  // Reset all morning supplications
  const handleReset = async () => {
    await resetSupplications('morning');
  };
